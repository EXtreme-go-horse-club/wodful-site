...
const highlights = [
  {
    label: "Leaderboard",
    headline: "Leaderboard ao vivo",
    description: "O público acompanha cada WOD em tempo real.",
    icon: Trophy,
    href: "#features",
  },
  {
  ...
  {
    label: "Cronograma",
    headline: "Baterias e raias no automático",
    description: "A competição evolui e a plataforma acompanha. Você não fica recalculando bateria na mão entre um prova e outra.",
    icon: Calendar,
    href: "#features",
  },
];
  ...
  >
    ...
    <Container className="relative py-10 sm:py-14 md:py-20 lg:min-h-[calc(100vh-4rem)] lg:py-24">
      ...
      >
        ...
        >
          Inscrições, scoreboard e cronograma
          <br />
